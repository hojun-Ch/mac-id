...
class COPO():
    ...
    def update_policy(self):
        ...
        self.old_optimizer = torch.optim.Adam(list(self.old_policy_network.parameters()) , lr=self.learning_rate)
        ...
        for epoch in range(self.ppo_epoch):
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                values, n_values, g_values, log_prob, entropy = self.evaluate_actions(rollout_data.observations, actions)
    ...
    def update_lcf(self):
        ...
        for epoch in range(self.lcf_epochs):
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                __, __, __, log_prob, __ = self.evaluate_actions(rollout_data.observations, actions)
                ...
                log_prob_from_old_policy = self.evaluate_actions_with_old(rollout_data.observations, actions)
